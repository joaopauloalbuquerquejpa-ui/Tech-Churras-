  ...
  if (done) {
    ...
    return (
      <div className="max-w-md mx-auto mt-12">
        ...
        {/* Google review CTA — aparece quando NEXT_PUBLIC_GOOGLE_REVIEW_URL estiver configurado */}
        {googleReviewUrl && (
          <a
            href={googleReviewUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 w-full bg-white hover:bg-gray-100 text-gray-900 font-bold py-3.5 px-4 rounded-2xl transition-colors mb-4"
          >
            ...
            <div className="text-left">
              <p className="text-sm font-bold leading-tight">Avaliar também no Google</p>
              <p className="text-xs text-gray-500 font-normal">Ajuda novos clientes a nos encontrar</p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 ml-auto text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
          </a>
        )}
