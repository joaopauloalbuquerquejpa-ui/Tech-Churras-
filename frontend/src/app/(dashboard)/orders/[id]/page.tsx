  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {paymentResult === 'success' && (
        <div className="mb-6 bg-green-900/30 border border-green-500/40 rounded-2xl p-5 text-center">
          <p className="text-4xl mb-2">🎉</p>
          <h2 className="text-xl font-black text-green-300 mb-1">Pagamento confirmado!</h2>
          <p className="text-gray-400 text-sm mb-4">Seu churrasco está reservado. O churrasqueiro foi notificado e confirmará em breve.</p>
          <button
            onClick={() => {
              const msg = `🔥 Churrasco marcado!\n\nContratei via Tech Churras. Acompanhe ao vivo quando o churrasqueiro estiver a caminho.\n\nhttps://www.techchurras.com.br`
              window.open(`https://wa.me/?text=${encodeURIComponent(msg)}`, '_blank')
            }}
            className="inline-flex items-center gap-2 bg-green-600/20 hover:bg-green-600/30 border border-green-600/40 text-green-400 text-sm font-bold px-5 py-2.5 rounded-xl transition-colors"
          >
