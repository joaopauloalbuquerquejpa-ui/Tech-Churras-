...
export default function ChurrasClubClient() {
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="max-w-5xl mx-auto px-4 pt-16 pb-12 text-center">
        <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/30 rounded-full px-4 py-1.5 text-sm text-orange-400 font-semibold mb-6">
          ...
          Em fase de lançamento — lista de espera aberta
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-20">
        ...
        <p className="text-center text-sm text-orange-400/70 mb-10">Abrimos as inscrições conforme a rede de churrasqueiros cresce · Entre na lista de espera abaixo</p>
          ...
          {submitted ? (
            ...
            <>
              ...
              <form onSubmit={handleInterest} className="space-y-3">
                <label htmlFor="cc-name" className="sr-only">Seu nome</label>
                <input
                  id="cc-name"
                  required
                  value={name}
                ...
                />
                <label htmlFor="cc-email" className="sr-only">Seu email</label>
                <input
                  id="cc-email"
                  required
                  type="email"
        ...
        <div className="space-y-3">
          {FAQS.map((f, i) => (
            <div key={i} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
              ...
              {faqOpen === i && (
                <div id={`cc-faq-${i}`} className="px-5 pb-4 text-sm text-gray-400 leading-relaxed">{f.a}</div>
              )}
            </div>
          ))}
        </div>
