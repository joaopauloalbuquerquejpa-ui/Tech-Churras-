...
export default function GrillmastersPage() {
  ...
  function renderStars(rating: number) {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      else if (i === full && partial) stars.push("½");
      else stars.push("☆");
    }
    return stars.join("");
  }
        ...
        <div style={{
          ...
          <div style={{ flex: "2 1 200px" }}>
            ...
            <form onSubmit={handleSearch} style={{ display: "flex", gap: 8 }}>
              <input
                type="text"
                placeholder="Ex: João, especialista em picanha..."
                value={search}
          ...
          <div style={{ flex: "1 1 140px" }}>
            ...
            >
              ...
              <option value="pricePerDay">Menor preço</option>
                ...
                >
                  ...
                  <div style={{ padding: "1.25rem 1.25rem 1rem" }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
                          ...
                          <span style={{
                            ...
                            {g.available ? "● Disponível" : "● Ocupado"}
                          </span>
                        </div>
                    ...
                    <div style={{
                      ...
                      <div>
                        <span style={{ fontSize: 11, color: "#999", display: "block" }}>Diária</span>
                      ...
                      >
                        {g.available ? "Contratar" : "Indisponível"}
                      </button>
                    </div>
                  </div>
                </div>
